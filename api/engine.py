...
def analyze_symbol(symbol: str, auto_optimize: bool = True,
                   ...
                   take_profit: float = 0.04, mode: str = "fixed",
                   allow_short: bool = False) -> dict:
    """Tek sembol icin tam analiz; React onyuzu icin JSON-uyumlu sozluk dondurur."""
    ...
    return {
        ...
        "params": {"threshold": round(t, 4), "stop_loss": round(sl, 4), "take_profit": round(tp, 4),
                   "mode": mode, "allow_short": allow_short, "auto_optimize": auto_optimize},
