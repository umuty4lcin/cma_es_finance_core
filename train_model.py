...
def train_global_model(timeframe='15m'):
    print("=" * 60)
    print("GLOBAL YAPAY ZEKA EGITIMI BASLIYOR")
    print("=" * 60)

    # Piyasayi temsil eden farkli sektorlerden egitim hisseleri
    ...
    print("Adim 1: Her sembol isleniyor ve paketleniyor...")

    for symbol in train_symbols:
        try:
            print(f"  -> Isleniyor: {symbol}...")
            ...
            print(f"  [!] {symbol} atlandi. Hata: {e}")
            continue

    if not X_train_list:
        print("\n[KRITIK HATA] Hicbir sembol islenemedi. Veritabanini kontrol et.")
        return

    print("\nAdim 2: Paketler Mega Veri Setine donusturuluyor...")
    ...
    print(f"  Global Sinif Agirliklari: {global_class_weights}")

    print("\nAdim 3: LSTM Modeli Insa Ediliyor ve Egitim Basliyor...")
    ...
    print(f"\n[BASARILI] Global Super Beyin egitildi ve kaydedildi: {model_save_path}")
